...
from .utils import ensure_dir, write_json, read_json, append_jsonl
...
class StateStore:
    ...
    def list_jobs(self) -> List[Dict[str, Any]]:
        jobs = [read_json(p, {}) for p in sorted(self.jobs_dir.glob("*.json"))]
    ...
    def emit_event(self, event_type: str, payload: Dict[str, Any]) -> None:
        append_jsonl(self.events_dir / "events.jsonl", {
            "time": utc_now(),
            "type": event_type,
            "payload": payload
        })
