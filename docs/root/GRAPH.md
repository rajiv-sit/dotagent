...
- **[AGENTS.md](../../AGENTS.md)** - Project instructions, defines how Agent should behave
  ...
  - Links to: [docs/](../README.md), [rules/](../../rules/), [rules/code-quality.md](../../rules/code-quality.md)
...
- **[CONTEXT.md](CONTEXT.md)** - Durable project memory across sessions
  ...
  - Related to: [docs/design/Architecture.md](../design/Architecture.md), design documents
...
- **[PLAN.md](PLAN.md)** - Active execution tracker (updated every sprint)
  ...
  - Related to: [docs/design/milestone.md](../design/milestone.md), weekly sprints
  - Updated when: Weekly [PLAN.md reminder](CHANGELOG.md#staying-updated)

- **[README.md](../../README.md)** - Project overview and getting started
  - Links to: [docs/quick-start.md](../quick-start.md), [docs/migration-guide.md](../migration-guide.md), [docs/](../README.md)
...
- **[CHANGELOG.md](CHANGELOG.md)** - Version history and what changed
  - Tracks: Changes to [rules/](../../rules/), [docs/](../README.md), [agents/](../../agents/), [skills/](../../skills/)
  - References: [docs/migration-guide.md](../migration-guide.md) for version upgrades
...
- [doc-reviewer.md](../../agents/doc-reviewer.md) - Documentation focus (validates [docs/](../README.md))
- [frontend-designer.md](../../agents/frontend-designer.md) - Frontend focus (uses [rules/frontend.md](../../rules/frontend.md))

**Uses**: [rules/](../../rules/) for project standards -> [rule-hierarchy.md](../rule-hierarchy.md)
**Runs**: [skills/](../../skills/) for workflows
**Linked to**: [docs/using-skills.md](../using-skills.md)
...
- [error-handling.md](../../rules/error-handling.md) - Error handling patterns (documented in [docs/](../README.md))
...
**Enforced by**: [skills/](../../skills/) during execution -> referenced in [docs/using-skills.md](../using-skills.md)
**Organized by**: [rule-hierarchy.md](../rule-hierarchy.md)
...
**Documented in**: [docs/using-skills.md](../using-skills.md)
...
- doc-presence.ps1 - Verify docs exist (checks [docs/](../README.md))
...
- [validate-links.ps1](../../.agent/scripts/validate-links.ps1) - Check markdown links (validates [docs/](../README.md))
...
**Referenced in**: [docs/using-skills.md](../using-skills.md)
...
**Referenced in**: [Starter Templates](../starter-templates.md)
...
- [index.md](../index.md) - Navigation hub (by role, question, time)
- [index.md](../index.md) - Navigation hub (by role, question, time)
- [quick-start.md](../quick-start.md) - 5-minute setup (new projects)
- [migration-guide.md](../migration-guide.md) - 5-phase adoption (existing projects)
- [faq.md](../faq.md) - 30+ common questions
- [troubleshooting.md](../troubleshooting.md) - Solutions for 20+ issues
- [customize-for-your-stack.md](../customize-for-your-stack.md) - Language-specific setup
- [rule-hierarchy.md](../rule-hierarchy.md) - Rule precedence and conflicts
- [using-skills.md](../using-skills.md) - Walkthrough of all 6 skills
- [github-actions-integration.md](../github-actions-integration.md) - CI/CD workflows
- [case-study.md](../case-study.md) - Real team metrics and validation
- [obsidian-integration.md](../obsidian-integration.md) - Obsidian vault setup
- [starter-templates.md](../starter-templates.md) - Copy-paste document templates
- [README.md](../README.md) - Documentation orientation guide
...
3. Add to [rule-hierarchy.md](../rule-hierarchy.md)
4. Update [CHANGELOG.md](CHANGELOG.md)

### Want to create a new skill?
1. Create `skills/your-skill/SKILL.md`
2. Update `skills/README.md` with new skill
3. Document in [using-skills.md](../using-skills.md)
4. Reference in [AGENTS.md](../../AGENTS.md)

### Want to add documentation?
1. Create `docs/your-guide.md`
2. Update [docs/README.md](../README.md) with new guide
3. Add to [docs/index.md](../index.md) for navigation
4. Update [CHANGELOG.md](CHANGELOG.md)

### Want to add a GitHub Action?
1. Create `.github/workflows/your-action.yml`
2. Document in [github-actions-integration.md](../github-actions-integration.md)
...
3. Use [docs/index.md](../index.md) for guided navigation
...
- [Obsidian Integration](../obsidian-integration.md) - How to view this graph in Obsidian
